...
data1 = data1.append(dffromdirectory(r'C:\Users\sudha\PycharmProjects\spam\emails\spam', 'spam'))
data1 = data1.append(dffromdirectory(r'C:\Users\sudha\PycharmProjects\spam\emails\ham', 'ham'))
